...
namespace llvm {
    ...
    : public DOTGraphTraits<cot::DepGraph *>
  {
    ...
    static std::string getGraphName(ProgramDependencyGraph *){return "Program Dependency Graph";}
	...
	case DATA_RAW:
	  {
	    ...
	    if(isa<LoadInst>(pInstruction)){
	      ...
	      errs() << "\n incorrect instruction for DATA_RAW node!" 
		     << "\n" << *pInstruction << "\n";
...
namespace cot
{
  ...
  }//  end defining struct DOTGraphTraits<cot::ProgramDependencyGraph *>
}// end llvm namespace
