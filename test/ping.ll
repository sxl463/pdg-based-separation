...
@hnamebuf = common global [64 x i8] zeroinitializer, align 256
...
entry:
  ...
  %argv.addr = alloca i8**, align 256
  %from = alloca %struct.sockaddr_in, align 4
  %av = alloca i8**, align 256
...
if.then30:                                        ; preds = %if.end
  ...
  store i8* getelementptr inbounds ([64 x i8]* @hnamebuf, i32 0, i32 0), i8** @hostname, align 256
  br label %if.end47
