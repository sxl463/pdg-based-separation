...
entry:
  ...
  %bitcast32 = bitcast i32* %retval to i8*
  call void @__softboundcets_spatial_store_dereference_check(i8* %bitcast, i8* %bitcast2, i8* %bitcast32, i64 ptrtoint (i32* getelementptr (i32* null, i32 1) to i64))
  store i32 0, i32* %retval
  %bitcast33 = bitcast i32* %argc.addr to i8*
  call void @__softboundcets_spatial_store_dereference_check(i8* %bitcast4, i8* %bitcast6, i8* %bitcast33, i64 ptrtoint (i32* getelementptr (i32* null, i32 1) to i64))
  store i32 %argc, i32* %argc.addr, align 4
  %bitcast34 = bitcast i8*** %argv.addr to i8*
  call void @__softboundcets_spatial_store_dereference_check(i8* %bitcast8, i8* %bitcast10, i8* %bitcast34, i64 ptrtoint (i1** getelementptr (i1** null, i32 1) to i64))
  store i8** %argv, i8*** %argv.addr, align 8
  %bitcast31 = bitcast i8*** %argv.addr to i8*
  call void @__softboundcets_metadata_store(i8* %bitcast31, i8* %0, i8* %1, i64 %2, i8* %3)
  %bitcast35 = bitcast i64* %result to i8*
  call void @__softboundcets_spatial_store_dereference_check(i8* %bitcast28, i8* %bitcast30, i8* %bitcast35, i64 ptrtoint (i64* getelementptr (i64* null, i32 1) to i64))
  store i64 0, i64* %result, align 8
  %bitcast36 = bitcast i32* %i to i8*
  call void @__softboundcets_spatial_store_dereference_check(i8* %bitcast20, i8* %bitcast22, i8* %bitcast36, i64 ptrtoint (i32* getelementptr (i32* null, i32 1) to i64))
  store i32 0, i32* %i, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %entry
  %bitcast37 = bitcast i32* %i to i8*
...
for.body:                                         ; preds = %for.cond
  ...
  %bitcast38 = bitcast i32* %i to i8*
  %6 = load i32* %i, align 4
  %idxprom = sext i32 %6 to i64
  %arrayidx = getelementptr inbounds [100 x i32]* %arr, i32 0, i64 %idxprom
  %bitcast39 = bitcast i32* %arrayidx to i8*
  call void @__softboundcets_spatial_store_dereference_check(i8* %bitcast12, i8* %bitcast14, i8* %bitcast39, i64 ptrtoint (i32* getelementptr (i32* null, i32 1) to i64))
...
for.end:                                          ; preds = %for.cond
  ...
  %bitcast40 = bitcast i32* %j to i8*
  call void @__softboundcets_spatial_store_dereference_check(i8* %bitcast24, i8* %bitcast26, i8* %bitcast40, i64 ptrtoint (i32* getelementptr (i32* null, i32 1) to i64))
  store i32 0, i32* %j, align 4
  br label %for.cond3

for.cond3:                                        ; preds = %for.inc14, %for.end
  %bitcast43 = bitcast i32* %j to i8*
...
for.cond6:                                        ; preds = %for.inc11, %for.body5
  %bitcast46 = bitcast i32* %i to i8*
  %9 = load i32* %i, align 4
  %bitcast47 = bitcast i32* %num to i8*
  call void @__softboundcets_spatial_load_dereference_check(i8* %bitcast16, i8* %bitcast18, i8* %bitcast47, i64 ptrtoint (i32* getelementptr (i32* null, i32 1) to i64))
  %10 = load i32* %num, align 4
  %cmp7 = icmp slt i32 %9, %10
  br i1 %cmp7, label %for.body8, label %for.end13

for.body8:                                        ; preds = %for.cond6
  %bitcast48 = bitcast i64* %result to i8*
  ...
  %bitcast50 = bitcast i32* %arrayidx10 to i8*
  call void @__softboundcets_spatial_load_dereference_check(i8* %bitcast12, i8* %bitcast14, i8* %bitcast50, i64 ptrtoint (i32* getelementptr (i32* null, i32 1) to i64))
  %13 = load i32* %arrayidx10, align 4
  %conv = sext i32 %13 to i64
  %add = add i64 %11, %conv
  %bitcast51 = bitcast i64* %result to i8*
  store i64 %add, i64* %result, align 8
  br label %for.inc11

for.inc11:                                        ; preds = %for.body8
  %bitcast52 = bitcast i32* %i to i8*
...
for.inc14:                                        ; preds = %for.end13
  %bitcast54 = bitcast i32* %j to i8*
  %15 = load i32* %j, align 4
  %inc15 = add nsw i32 %15, 1
  %bitcast55 = bitcast i32* %j to i8*
  store i32 %inc15, i32* %j, align 4
  br label %for.cond3

for.end16:                                        ; preds = %for.cond3
  %bitcast45 = bitcast i64* %result to i8*
